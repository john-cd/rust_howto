...
- [Aerospace](categories/aerospace/index.md)
  - [Aerospace](categories/aerospace/aerospace.md)

- [Aerospace - Drones](categories/aerospace_drones/index.md)
  - [Drones](categories/aerospace_drones/drones.md)

- [Aerospace - Protocols](categories/aerospace_protocols/index.md)
  - [Protocols](categories/aerospace_protocols/aerospace_protocols.md)

- [Aerospace - Simulation](categories/aerospace_simulation/index.md)
  - [Simulation](categories/aerospace_simulation/aerospace_simulation.md)

- [Aerospace - Space Protocols](categories/aerospace_space-protocols/index.md)
  - [Space Protocols](categories/aerospace_space-protocols/space_protocols.md)

- [Aerospace - Unmanned Aerial Vehicles](categories/aerospace_unmanned-aerial-vehicles/index.md)
  - [UAVs](categories/aerospace_unmanned-aerial-vehicles/uavs.md)

- [API bindings](categories/api-bindings/index.md)

- [Architecture](other/architecture/index.md)
  - [Architectural Patterns](other/architecture/architectural_patterns.md)
  - [Common Architectures](other/architecture/common_architectures.md)
  - [Software Architecture Process](other/architecture/software_architecture_process.md)

- [Audio](categories/multimedia_audio/index.md)
