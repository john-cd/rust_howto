...
- [`serde`][c~serde~docs]↗{{hi:serde}}: Often used for serializing and deserializing data passed between Rust and Node.js.
- [`serde_json`][c~serde_json~docs]↗{{hi:serde_json}}: If you're exchanging [JSON][p~json] data.
