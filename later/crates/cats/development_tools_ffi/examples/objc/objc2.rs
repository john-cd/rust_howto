...
fn main() {
    ...
    unsafe {
        ...
        // Note: in actual objc2 this would need more setup but this represents the concept
        // let string: *mut objc2::runtime::AnyObject = msg_send![string, initWithString: "Hello from Rust!"];
