...
```rust
{{#include ../../deps/tests/lang/copy.rs}}
```
...
```rust
{{#include ../../deps/tests/lang/borrowing.rs}}
```

### Mutable reference

```rust
{{#include ../../deps/tests/lang/borrowing_mutable.rs}}
```
