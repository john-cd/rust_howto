...
Readers should have already some basic familiarity with {{hi:Rust}}[`Rust`][rust]⮳ concepts. The {{hi:Rust book}}[`Rust book`][book-rust]⮳ is an excellent resource for complete beginners to get started with.
