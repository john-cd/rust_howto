...
[![approx][approx-badge]][c-approx]  [`{{i:Approx}}`][c-Approx]⮳

[cargo-nextest][cargo-nextest-website]⮳: `cargo nextest run; cargo test --doc`  [![cat-development-tools][cat-development-tools-badge]][cat-development-tools]
