...
```rust
{{#include ../../../deps/tests/cats/mathematics/side_length.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/tan_sin_cos.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/latitude_longitude.rs}}
```
