...
```rust,editable
{{#include ../../../crates/ex/categories/mn/tests/mathematics/side_length.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/mn/tests/mathematics/tan_sin_cos.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/mn/tests/mathematics/latitude_longitude.rs:example}}
```
