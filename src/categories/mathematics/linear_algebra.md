...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/add_matrices.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/multiply_matrices.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/multiply_scalar_vector_matrix.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/vector_comparison.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/vector_norm.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/invert_matrix.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/deserialize_matrix.rs:example}}
```
