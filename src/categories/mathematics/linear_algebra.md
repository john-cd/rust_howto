...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/add_matrices.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/multiply_matrices.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/multiply_scalar_vector_matrix.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/vector_comparison.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/vector_norm.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/invert_matrix.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/linear_algebra/deserialize_matrix.rs:example}}
```
