...
```rust
{{#include ../../../deps/tests/cats/mathematics/add_matrices.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/multiply_matrices.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/multiply_scalar_vector_matrix.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/vector_comparison.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/vector_norm.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/invert_matrix.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/deserialize_matrix.rs}}
```
