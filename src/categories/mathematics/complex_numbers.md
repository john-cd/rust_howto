...
Creates complex numbers of type [`{{i:num::complex::Complex}}`][num::complex::Complex]⮳. Both the real and imaginary part of the complex number must be of the same type.
