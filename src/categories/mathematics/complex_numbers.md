...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/create_complex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/add_complex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/mathematical_functions.rs:example}}
```
