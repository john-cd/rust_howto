...
Creates complex numbers of type {{hi:num::complex::Complex}}[`num::complex::Complex`][c-num::complex::Complex]⮳. Both the real and imaginary part of the complex number must be of the same type.
