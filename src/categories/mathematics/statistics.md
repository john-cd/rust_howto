...
```rust
{{#include ../../../deps/tests/cats/mathematics/central_tendency.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/central_tendency1.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/mathematics/standard_deviation.rs:example}}
```
