...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/central_tendency.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/central_tendency1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/central_tendency2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/standard_deviation.rs:example}}
```
