...
```rust,editable
{{#include ../../../deps/tests/categories/mathematics/central_tendency.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/mathematics/central_tendency1.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/mathematics/central_tendency2.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/mathematics/standard_deviation.rs:example}}
```
