...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/num_traits.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/big_integers.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/num_bigint.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/rug.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/rust_decimal.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/ordered_float.rs:example}}
```
