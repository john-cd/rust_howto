...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/num_traits.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/big_integers.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/num_bigint.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/rug.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/rust_decimal.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/additional_numeric_types/ordered_float.rs:example}}
```
