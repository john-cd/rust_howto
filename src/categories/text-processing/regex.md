...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/email.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/hashtags.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/phone.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/filter_log.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/replace.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/regex/fancy_regex.rs:example}}
```
