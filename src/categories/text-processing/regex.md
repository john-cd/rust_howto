...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/email.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/hashtags.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/phone.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/filter_log.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/replace.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/stuv/tests/text_processing/fancy_regex.rs:example}}
```
