...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/email.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/hashtags.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/phone.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/filter_log.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/replace.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/fancy_regex.rs:example}}
```
