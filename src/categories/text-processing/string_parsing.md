...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/string_parsing/graphemes.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/text_processing/tests/string_parsing/from_str.rs:example}}
```
