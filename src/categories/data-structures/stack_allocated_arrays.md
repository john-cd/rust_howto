...
{{#include ../../../crates/ex/cats/data_structures/tests/arrayvec.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/cats/data_structures/tests/smallvec.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/cats/data_structures/tests/tinyvec.rs:example}}
```
