...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/ml/linfa.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/ml/smartcore.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/ml/candle.rs:example}}
```
