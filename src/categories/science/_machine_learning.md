...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/linfa.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/smartcore.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/science/tests/candle.rs:example}}
```
