...
```rust,editable
{{#include ../../../crates/ex/cats/database/sqlite/tests/initialization.rs:example}}
```
...
{{#include ../../../crates/ex/cats/database/sqlite/tests/insert_select.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/cats/database/sqlite/tests/transactions.rs:example}}
```
