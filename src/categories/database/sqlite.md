...
```rust
{{#include ../../../deps/tests/cats/databases/sqlite/initialization.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/databases/sqlite/insert_select.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/databases/sqlite/transactions.rs:example}}
```
