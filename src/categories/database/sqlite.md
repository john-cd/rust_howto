...
```rust
{{#include ../../../deps/tests/cats/databases/initialization.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/databases/insert_select.rs:example}}
```
...
```rust
{{#include ../../../deps/tests/cats/databases/transactions.rs:example}}
```
