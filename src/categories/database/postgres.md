...
{{#include ../../../crates/ex/categories/d/tests/database/postgres/create_tables.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/categories/d/tests/database/postgres/insert_query_data.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/categories/d/tests/database/postgres/aggregate_data.rs:example}}
```
