...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/string.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/filename.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/request.rs:example}}
```
