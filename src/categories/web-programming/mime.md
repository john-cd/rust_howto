...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/mime/string.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/mime/filename.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/mime/request.rs:example}}
```
