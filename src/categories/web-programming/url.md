...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/parse.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/base.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/new.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/origin.rs:example}}
```

[`url::Url::origin`][c-url::Url::origin]{{hi:url::Url::origin}}⮳ produces the same result.

```rust,editable
{{#include ../../../deps/tests/categories/web_programming/origin1.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/fragment.rs:example}}
```
