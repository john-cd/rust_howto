...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/extract_links.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/broken.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/web_programming/unique.rs:example}}
```
