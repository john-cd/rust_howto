...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/scraping/extract_links.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/scraping/broken.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/scraping/unique.rs:example}}
```
