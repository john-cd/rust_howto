...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/extract_links.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/broken.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/unique.rs:example}}
```
