...
```rust
{{#include ../../../deps/tests/cats/web_programming/extract_links.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/web_programming/broken.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/web_programming/unique.rs}}
```
