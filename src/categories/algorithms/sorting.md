...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/sort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/sort_float.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/sort_struct.rs:example}}
```
