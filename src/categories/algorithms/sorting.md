...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/sort.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/sort_float.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/sort_struct.rs:example}}
```
