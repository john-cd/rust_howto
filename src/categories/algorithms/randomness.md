...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_range.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_range1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_dist.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_custom.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_passwd.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/algorithms/tests/rand/rand_choose.rs:example}}
```
