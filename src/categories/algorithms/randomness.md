...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_range.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_range1.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_dist.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_custom.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_passwd.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/algorithms/rand_choose.rs}}
```
