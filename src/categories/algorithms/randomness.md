...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_range.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_range1.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_dist.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_custom.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_passwd.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/algorithms/rand_choose.rs:example}}
```
