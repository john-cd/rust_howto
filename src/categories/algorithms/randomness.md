...
```rust
{{#include ../../../deps/tests/rand_range.rs}}
```
...
```rust
{{#include ../../../deps/tests/rand_range1.rs}}
```
...
```rust
{{#include ../../../deps/tests/rand_dist.rs}}
```
...
```rust
{{#include ../../../deps/tests/rand_custom.rs}}
```
...
```rust
{{#include ../../../deps/tests/rand_passwd.rs}}
```
...
```rust
{{#include ../../../deps/tests/rand_choose.rs}}
```
