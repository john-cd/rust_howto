...
```rust,editable
{{#include ../../../crates/ex/cats/cryptography/tests/aes_gcm_siv.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/cryptography/tests/aes_gcm.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/cryptography/tests/subtle.rs:example}}
```
