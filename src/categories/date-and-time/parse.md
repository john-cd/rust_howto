...
```rust
{{#include ../../../deps/tests/cats/date_and_time/current.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/date_and_time/timestamp.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/date_and_time/format.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/date_and_time/string.rs}}
```
