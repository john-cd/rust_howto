...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/current.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/timestamp.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/format.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/parse_string_into_datetime.rs:example}}
```
