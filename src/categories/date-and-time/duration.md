...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/profile.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/checked.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/timezone.rs:example}}
```
