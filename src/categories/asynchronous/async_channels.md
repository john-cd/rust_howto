...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_channels/async_channels_oneshot.rs:example}}
```

Another example:

```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_channels/async_channels_oneshot2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_channels/postage.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_channels/kanal.rs:example}}
```
