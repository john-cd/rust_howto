...
```rust,editable
{{#include ../../../deps/tests/categories/asynchronous/async_traits.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/asynchronous/async_traits2.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/asynchronous/async_traits3.rs:example}}
```
...
<div class="hidden">
TODO P1 review new Rust features
