...
```rust,editable
{{#include ../../../crates/ex/categories/ab/tests/asynchronous/async_traits.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/ab/tests/asynchronous/async_traits2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/ab/tests/asynchronous/async_traits3.rs:example}}
```
