...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_traits/async_traits.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_traits/async_traits2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/async_traits/async_traits3.rs:example}}
```
