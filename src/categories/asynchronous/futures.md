...
In most cases, you will use this crate directly only when writing async code{{hi:async code}} intended to work for multiple runtimes. Otherwise, use the utilities provided by the ecosystem of your choice - [Tokio](tokio.md) for example.
