...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/tokio2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/asynchronous/tests/tokio21.rs:example}}
```
...
{{#include ../../../crates/ex/cats/asynchronous/tests/tokio_graceful_shutdown.rs:example}}
```
