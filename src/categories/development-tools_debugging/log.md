...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log/log_debug.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log/log_error.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log/log_stdout.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log/log_custom_logger.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log/log_syslog.rs:example}}
```
