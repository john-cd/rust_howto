...
[![log][c-log-badge]][c-log]{{hi:log}}  [![env_logger][c-env_logger-badge]][c-env_logger]{{hi:env_logger}}  [![cat-debugging][cat-debugging-badge]][cat-debugging]{{hi:Debugging}}{{hi:Debug message}}
...
[![log][c-log-badge]][c-log]{{hi:log}}  [![cat-debugging][cat-debugging-badge]][cat-debugging]{{hi:Debugging}}
...
[![log][c-log-badge]][c-log]{{hi:log}}  [![syslog][c-syslog-badge]][c-syslog]{{hi:syslog}}  [![cat-debugging][cat-debugging-badge]][cat-debugging]{{hi:Debugging}}{{hi:syslog}}
