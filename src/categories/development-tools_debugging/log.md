...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log_debug.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log_error.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log_stdout.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log_custom_logger.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/log_syslog.rs:example}}
```
