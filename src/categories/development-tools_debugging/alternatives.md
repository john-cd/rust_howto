...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/slog.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/open_telemetry.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/development_tools_debugging/tests/open_observe.rs:example}}
```
