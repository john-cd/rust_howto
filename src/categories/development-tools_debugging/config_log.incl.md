...
| [Enable log levels per module][ex-enable-log-levels-per-module] |  |  |
| [Use a custom environment variable to set up logging][ex-custom-env-var-for-logging] |  |  |
| [Include timestamp in log messages][ex-timestamp-in-log-messages] |  |  |
| [Log messages to a custom location][ex-log-to-custom-location] |  |  |
