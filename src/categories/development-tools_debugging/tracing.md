...
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_subscriber.rs:example}}
```

### Combine layers {#combine-layers}

```rust,editable,noplayground
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_subscriber2.rs:example}}
```

Or with a custom formatting layer

```rust,editable,noplayground
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_subscriber3.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_subscriber4.rs:example}}
```

## Events {#events}

```rust,editable
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing.rs:example}}
```

## Spans {#spans}

```rust,editable
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_spans.rs:example}}
```

One-liner with `.entered()`:

```rust,editable
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_span_entered.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_span_in_scope.rs:example}}
```

## Add tracing spans to functions {#add-tracing-spans-to-fn}

```rust,editable
{{#include ../../../crates/ex/categories/d/tests/development_tools_debugging/tracing_instrument.rs:example}}
```
