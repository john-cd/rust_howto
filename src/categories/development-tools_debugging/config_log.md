...
```rust
{{#include ../../../deps/tests/cats/development_tools_debugging/log_mod.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/development_tools_debugging/log_env_variable.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/development_tools_debugging/log_timestamp.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/development_tools_debugging/log_custom.rs}}
```
