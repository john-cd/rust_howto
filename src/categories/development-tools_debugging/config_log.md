...
```rust,editable
{{#include ../../../deps/tests/categories/development_tools_debugging/log_mod.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/development_tools_debugging/log_timestamp.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/development_tools_debugging/log_custom.rs:example}}
```
