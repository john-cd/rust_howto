...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/parsing/nom.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/parsing/pest.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/parsing/tree_sitter.rs:example}}
```
