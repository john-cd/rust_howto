...
```rust,editable
{{#include ../../../crates/ex/cats/os/tests/process_output.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/os/tests/send_input.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/os/tests/piped.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/os/tests/error_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/os/tests/continuous.rs:example}}
```
