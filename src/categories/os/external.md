...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/process_output.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/send_input.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/piped.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/error_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/continuous.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/os/read_env_variable.rs:example}}
```
