...
Declares a lazily evaluated constant [`{{i:HashMap}}`][std::collections::HashMap]⮳. The [`{{i:HashMap}}`][std::collections::HashMap]⮳ will be evaluated once and stored behind a global static reference.
