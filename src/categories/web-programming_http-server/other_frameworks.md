...
```rust,editable
{{#include ../../../crates/ex/categories/wxyz/tests/web_programming_http_server/rocket.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/wxyz/tests/web_programming_http_server/leptos.rs:example}}
```
