...
```rust
{{#include ../../../../deps/tests/cats/rust_patterns/anyhow.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/rust_patterns/thiserror.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/rust_patterns/thiserror2.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/rust_patterns/miette.rs}}
```
