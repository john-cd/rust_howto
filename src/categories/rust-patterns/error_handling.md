...
{{#include ../../../deps/tests/categories/rust_patterns/panic.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/rust_patterns/question_mark2.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/rust_patterns/backtrace.rs:example}}
```
