...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/rust_patterns/anyhow.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/rust_patterns/thiserror.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/rust_patterns/thiserror2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/rust_patterns/miette.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/opqr/tests/rust_patterns/color_eyre.rs:example}}
```
