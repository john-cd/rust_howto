...
```rust,editable
{{#include ../../../crates/ex/cats/rust_patterns/tests/anyhow.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/rust_patterns/tests/thiserror.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/rust_patterns/tests/thiserror2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/rust_patterns/tests/miette.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/rust_patterns/tests/color_eyre.rs:example}}
```
