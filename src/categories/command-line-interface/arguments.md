...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/command_line_interface/clap_basic.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/command_line_interface/clap.rs:example}}
```
