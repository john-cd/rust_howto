...
```rust,editable
{{#include ../../../crates/ex/cats/command_line_interface/tests/arguments/clap_basic.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/command_line_interface/tests/arguments/clap.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/command_line_interface/tests/arguments/lexopt.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/command_line_interface/tests/arguments/pico_args.rs:example}}
```
