...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/command_line_interface/ansi_term_basic.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/command_line_interface/ansi_term_basic1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/command_line_interface/ansi_term_basic2.rs:example}}
```
