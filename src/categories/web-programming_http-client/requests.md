...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/requests/get.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/requests/get1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/requests/header.rs:example}}
```
