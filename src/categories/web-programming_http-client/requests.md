...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/get.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/get1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/header.rs:example}}
```
