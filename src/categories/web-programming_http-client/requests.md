...
```rust
{{#include ../../../deps/tests/cats/web_programming_http_client/get.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/web_programming_http_client/get1.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/web_programming_http_client/header.rs}}
```
