...
Queries GitHub [stargazers API v3](https://developer.github.com/v3/activity/starring/#list-stargazers)⮳ with [`reqwest::get`][reqwest::get]⮳ to get list of all users who have marked a GitHub project with a star. [`reqwest::Response`][reqwest::Response]⮳ is deserialized with [`Response::json`][reqwest::Response::json]⮳ into `User` objects implementing [`serde::Deserialize`][serde::Deserialize]⮳.
