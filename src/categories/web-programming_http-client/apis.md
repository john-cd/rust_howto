...
[`{{i:tokio::main}}`][c-tokio_tutorial_hello_tokio-website] is used to set up the async executor and the process waits for [`{{i:reqwest::get}}`][c-reqwest::get] to complete before processing the response into User instances.
