...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/rest_get.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/rest_head.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/rest_post.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/paginated.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/rate_limited.rs:example}}
```
