...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/apis/rest_get.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/apis/rest_head.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/apis/rest_post.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/apis/paginated.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming_http_client/tests/apis/rate_limited.rs:example}}
```
