...
[![rustup][rustup-website-badge]][rustup-website] [![cat-development-tools][cat-development-tools-badge]][cat-development-tools]{{hi:Development tools}}

[Rustup][p-rustup]⮳ installs, manages, and upgrades versions of `rustc`, `cargo`, `clippy`, `rustfmt`, etc.
