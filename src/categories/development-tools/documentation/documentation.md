...
```rust,editable
{{#include ../../../../crates/ex/cats/development_tools/tests/rustdoc.rs:example}}
```

[`rustdoc`][book-rustdoc]{{hi:rustdoc}}⮳ uses the CommonMark Markdown specification.

```rust,editable
{{#include ../../../../crates/ex/cats/development_tools/tests/rustdoc2.rs:example}}
```
...
```rust,editable
{{#include ../../../../crates/ex/cats/development_tools/tests/rustdoc3.rs:example}}
```
