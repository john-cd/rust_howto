...
```rust
{{#include ../../../../deps/tests/cats/development_tools/semver_increment.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/development_tools/semver_complex.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/development_tools/semver_prerelease.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/development_tools/semver_latest.rs}}
```
...
```rust
{{#include ../../../../deps/tests/cats/development_tools/semver_command.rs}}
```
