...
```rust,editable
{{#include ../../../../deps/tests/categories/development_tools/semver_increment.rs:example}}
```
...
```rust,editable
{{#include ../../../../deps/tests/categories/development_tools/semver_latest.rs:example}}
```
...
```rust,editable
{{#include ../../../../deps/tests/categories/development_tools/semver_command.rs:example}}
```
