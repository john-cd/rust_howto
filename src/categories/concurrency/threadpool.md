...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/threadpool_walk.rs:example}}
```
...
{{#include ../../../crates/ex/categories/c/tests/concurrency/threadpool_fractal.rs:example}}
```
