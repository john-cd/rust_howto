...
```rust
{{#include ../../../deps/tests/rayon_iter_mut.rs}}
```
...
```rust
{{#include ../../../deps/tests/rayon_any_all.rs}}
```
...
```rust
{{#include ../../../deps/tests/rayon_parallel_search.rs}}
```
...
```rust
{{#include ../../../deps/tests/rayon_parallel_sort.rs}}
```
...
```rust
{{#include ../../../deps/tests/rayon_map_reduce.rs}}
```
...
```rust
{{#include ../../../deps/tests/rayon_thumbnails.rs}}
```
