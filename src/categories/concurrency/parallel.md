...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_iter_mut.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_any_all.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_parallel_search.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_parallel_sort.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_map_reduce.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/concurrency/rayon_thumbnails.rs}}
```
