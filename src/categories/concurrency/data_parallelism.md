...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/multithreading_rayon.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/multithreading_rayon_parsort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/multithreading_rayon_custom.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_iter_mut.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_any_all.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_parallel_search.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_parallel_sort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_map_reduce.rs:example}}
```
...
{{#include ../../../crates/ex/cats/concurrency/tests/rayon_thumbnails.rs:example}}
```
