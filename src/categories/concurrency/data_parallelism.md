...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/multithreading_rayon.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/multithreading_rayon_parsort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/multithreading_rayon_custom.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_iter_mut.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_any_all.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_parallel_search.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_parallel_sort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_map_reduce.rs:example}}
```
...
{{#include ../../../crates/ex/cats/concurrency/tests/data_parallelism/rayon_thumbnails.rs:example}}
```
