...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/multithreading_rayon.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/multithreading_rayon_parsort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/multithreading_rayon_custom.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_iter_mut.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_any_all.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_parallel_search.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_parallel_sort.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_map_reduce.rs:example}}
```
...
{{#include ../../../crates/ex/categories/c/tests/concurrency/rayon_thumbnails.rs:example}}
```
