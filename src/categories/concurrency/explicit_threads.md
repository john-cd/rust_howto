...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/multithreading_spawn_join.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/c/tests/concurrency/multithreading_scoped_threads.rs:example}}
```
