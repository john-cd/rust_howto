...
```rust
{{#include ../../../deps/tests/cats/encoding/read.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/read1.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/delimiter.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/filter.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/invalid.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/serialize.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/serde_serialize.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/transform.rs}}
```
