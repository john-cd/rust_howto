...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/serde.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/serde_json.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/monostate.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/serde_ignored.rs:example}}
```
