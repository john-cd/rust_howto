...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/percent_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/url_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/hex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/base64.rs:example}}
```
