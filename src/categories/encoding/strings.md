...
```rust
{{#include ../../../deps/tests/cats/encoding/percent_encode.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/url_encode.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/hex.rs}}
```
...
```rust
{{#include ../../../deps/tests/cats/encoding/base64.rs}}
```
