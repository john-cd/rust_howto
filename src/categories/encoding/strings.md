...
```rust,editable
{{#include ../../../deps/tests/categories/encoding/percent_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/encoding/hex.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/encoding/base64.rs:example}}
```
