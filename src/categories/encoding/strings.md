...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/encoding/percent_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/encoding/url_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/encoding/hex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/encoding/base64.rs:example}}
```
