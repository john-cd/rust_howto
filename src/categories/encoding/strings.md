...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/strings/percent_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/strings/url_encode.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/strings/hex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/encoding/tests/strings/base64.rs:example}}
```
