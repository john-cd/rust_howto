...
```rust,editable
{{#include ../../../crates/ex/cats/gui/examples/femtovg.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/gui/examples/skia_safe.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/gui/examples/vello.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/gui/examples/vger.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/gui/examples/webrender.rs:example}}
```
