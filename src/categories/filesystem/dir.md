...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/modified.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/loops.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/duplicate_name.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/find_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/skip_dot.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/sizes.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/png.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/ignore_case.rs:example}}
```
