...
```rust,editable
{{#include ../../../deps/tests/categories/filesystem/modified.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/filesystem/loops.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/filesystem/find_file.rs:example}}
```
...
```rust,editable
{{#include ../../../deps/tests/categories/filesystem/ignore_case.rs:example}}
```
