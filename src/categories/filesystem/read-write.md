...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/read_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/same_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/categories/efghijkl/tests/filesystem/memmap2.rs:example}}
```
