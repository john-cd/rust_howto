...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/read_write/read_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/read_write/same_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/read_write/memmap2.rs:example}}
```
