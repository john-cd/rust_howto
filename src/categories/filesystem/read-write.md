...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/read_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/same_file.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/filesystem/tests/memmap2.rs:example}}
```
