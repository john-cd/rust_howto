...
This book's long-term goal is the coverage of the 'most commonly used' Rust crates, as defined by [`{{i:blessed.rs}}`][blessed-rs]⮳, the most downloaded libraries in [`{{i:crates.io}}`][crates-io]⮳, and 'high quality crates' per [`{{i:lib.rs}}`][lib-rs]⮳ [statistics][lib-rs-stats]⮳. Review [{{i:key crates}}](../key_crates.md) for topic ideas.
