...
If you don't want to use {{i:Dev Container}}, use the following from the project's root directory to manually build the [`docker`][docker]⮳ image and run it.
...
To test the [`docker`][docker]⮳ image manually, use
