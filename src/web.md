...
[ex-extract-links-webpage]: ../drafts/web/scraping.html#extract-all-links-from-a-webpage-html
[ex-check-broken-links]: ../drafts/web/scraping.html#check-a-webpage-for-broken-links
[ex-extract-mediawiki-links]: ../drafts/web/scraping.html#extract-all-unique-links-from-a-mediawiki-markup

[ex-url-parse]: ../drafts/web/url.html#parse-a-url-from-a-string-to-a-url-type
[ex-url-base]: ../drafts/web/url.html#create-a-base-url-by-removing-path-segments
[ex-url-new-from-base]: ../drafts/web/url.html#create-new-urls-from-a-base-url
[ex-url-origin]: ../drafts/web/url.html#extract-the-url-origin-scheme--host--port
[ex-url-rm-frag]: ../drafts/web/url.html#remove-fragment-identifiers-and-query-pairs-from-a-url

[ex-mime-from-string]: ../drafts/web/mime.html#get-mime-type-from-string
[ex-mime-from-filename]: ../drafts/web/mime.html#get-mime-type-from-filename
[ex-http-response-mime-type]: ../drafts/web/mime.html#parse-the-mime-type-of-a-http-response
