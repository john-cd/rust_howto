...
[ex-log-debug]: development_tools/development_tools/debugging/log.md#log-a-debug-message-to-the-console
[ex-log-error]: development_tools/development_tools/debugging/log.md#log-an-error-message-to-the-console
[ex-log-stdout]: development_tools/development_tools/debugging/log.md#log-to-stdout-instead-of-stderr
[ex-log-custom-logger]:  development_tools/development_tools/debugging/log.md#log-messages-with-a-custom-logger
[ex-log-syslog]: development_tools/development_tools/debugging/log.md#log-to-the-unix-syslog
[ex-log-mod]: development_tools/development_tools/debugging/config_log.md#enable-log-levels-per-module
[ex-log-env-variable]: development_tools/development_tools/debugging/config_log.md#use-a-custom-environment-variable-to-set-up-logging
[ex-log-timestamp]: development_tools/development_tools/debugging/config_log.md#include-timestamp-in-log-messages
[ex-log-custom]: development_tools/development_tools/debugging/config_log.md#log-messages-to-a-custom-location
