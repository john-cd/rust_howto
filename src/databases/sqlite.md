...
[`Connection::open`][Connection::open] will open the database `cats` created in the earlier recipe.
...
roll back unless committed explicitly with [`Transaction::commit`][Transaction::commit]
