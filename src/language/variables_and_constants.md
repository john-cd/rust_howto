...
```rust,editable
{{#include ../../deps/tests/language/vars_and_consts.rs:example}}
```

## Shadowing {#shadowing}

```rust,editable
{{#include ../../deps/tests/language/shadowing.rs:example}}
```
...
```rust,editable
{{#include ../../deps/tests/language/destructuring.rs:example}}
```
