...
mod tests {
    ...
    #[test]
    fn test_parse_code_span_with_leading_and_trailing_text() {
        assert_eq!(
            parse_code_span("Some text `code here` more text"),
    ...
    #[test]
    fn test_parse_code_span_inner_backticks() {
        assert_eq!(
            parse_code_span("``foo ` bar``"),
            Ok(("", Element::CodeSpan("foo ` bar")))
        );
    }
    ...
    #[test]
    fn test_parse_fenced_code_block_with_leading_and_trailing_text() {
        let input = "Some text ```println!(\"hi\");``` more text";
        let expected = Element::FencedCodeBlock("println!(\"hi\");");
