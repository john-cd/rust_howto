...
fn main() {
    // Using FNV hasher for better performance with small keys.
    // Not suitable if there is a risk of denial-of-service attacks.
    // Be certain that your program is not exposed to malicious inputs.
