...
// // encrypted signature using their private key, and a verifier can assert the
// // source if it is decrypted correctly using the declared public key.
...
//     // pairs of private and public keys.
//     let private_key_der = secret_key.to_pkcs8()?;
//     // Get it in PEM format. The PEM text encoding is
//     // a `Base64` representation.
//     let private_key_pem = private_key_der.to_pem()?;
