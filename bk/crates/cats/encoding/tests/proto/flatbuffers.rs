...
// //! create data, and serialize it into a FlatBuffer.
// //!
...
// flatbuffers_gen::r#gen::include_file!("my_game.fbs");
// // Assuming your schema is in `my_game.fbs`.
// // You can define your schema in a `.fbs` file.
