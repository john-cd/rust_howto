...
```rust,editable
{{#include ../../../crates/cats/science_robotics/tests/robotics_frameworks/zenoh.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/science_robotics/tests/robotics_frameworks/openrr.rs:example}}
```
