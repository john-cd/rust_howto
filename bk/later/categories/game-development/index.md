...
| Physics Engine | See [Physics][are-we-game-yet?-physics~website] for 2D and 3D physics engines, collision detection libraries. | [`rapier`](https://rapier.rs): A physics engine (2D and 3D). `nphysics2d`{{hi:nphysics2d}}: Another physics engine. |
