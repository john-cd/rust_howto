...
- When you need to transfer ownership of data between functions where you need a stable address - alhough `Arc<T>` or `Rc<T>` might be more appropriate for shared ownership.
