...
```rust,editable
{{#include ../../../crates/cats/data_structures/tests/hashmap/hashmap.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/data_structures/tests/hashmap/hashset.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/data_structures/tests/hashmap/custom_type_as_key.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/data_structures/tests/hashmap/custom_hash_function.rs:example}}
```
