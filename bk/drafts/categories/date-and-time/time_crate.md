...
[`time`][c~time~docs]⮳{{hi:time}} is a [date and time][p~date-and-time] library that is fully interoperable with the [standard library][p~standard-library] and mostly compatible with `#![no_std]`.
