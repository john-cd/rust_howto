...
| [Run Code at Scope Exit with `scopeguard`][ex~rust-patterns~scopeguard] | [![scopeguard][c~scopeguard~docs~badge]][c~scopeguard~docs] | [![cat~rust-patterns][cat~rust-patterns~badge]][cat~rust-patterns] |
