...
Instead of "casting," you'll usually implement or use [traits][p~traits] like [`From`](https://doc.rust-lang.org/std/convert/trait.From.html)↗{{hi:std::convert::From}}, [`Into`](https://doc.rust-lang.org/std/convert/trait.Into.html)↗{{hi:std::convert::Into}}, [`TryFrom`](https://doc.rust-lang.org/std/convert/trait.TryFrom.html)↗{{hi:std::convert::TryFrom}}, [`TryInto`](https://doc.rust-lang.org/std/convert/trait.TryInto.html)↗{{hi:std::convert::TryInto}}, or [`FromStr`](https://doc.rust-lang.org/std/str/trait.FromStr.html)↗{{hi:FromStr}} for type conversions in Rust. The [`as`](https://doc.rust-lang.org/std/keyword.as.html)↗{{hi:as}} keyword exists, but it should be used carefully and only when other options aren't suitable, as it can lead to data loss or unexpected behavior if not handled properly.
...
The [`From`](https://doc.rust-lang.org/std/convert/trait.From.html)↗{{hi:std::convert::From}} and [`Into`](https://doc.rust-lang.org/std/convert/trait.Into.html)↗{{hi:std::convert::Into}} [traits][p~traits] are used for conversions that should always succeed. [`From`](https://doc.rust-lang.org/std/convert/trait.From.html)↗{{hi:std::convert::From}} allows you to define how to convert from a type, and [`Into`](https://doc.rust-lang.org/std/convert/trait.Into.html)↗{{hi:std::convert::Into}} provides a blanket implementation for converting into a type if From is implemented. This is the preferred way to do type conversions in most cases.

The [`TryFrom`](https://doc.rust-lang.org/std/convert/trait.TryFrom.html)↗{{hi:std::convert::TryFrom}} and [`TryInto`](https://doc.rust-lang.org/std/convert/trait.TryInto.html)↗{{hi:std::convert::TryInto}} [traits][p~traits] are used for conversions that might fail. They return a [`Result`](https://doc.rust-lang.org/std/result/enum.Result.html)↗{{hi:std::result::Result}} to indicate success or failure. Use these when there's a possibility of the conversion not working (e.g., [parsing][p~parsing] a string to a number).

## Parsing Strings with the `FromStr` Trait {#skip2}

The [`FromStr`]( ){{hi: }} trait is used for [parsing][p~parsing] strings into other types. Many standard types implement [`FromStr`](https://doc.rust-lang.org/std/str/trait.FromStr.html)↗{{hi:FromStr}}.
...
Use the [`as`](https://doc.rust-lang.org/std/keyword.as.html)↗{{hi:as}} keyword, but be very cautious about potential loss of data or unexpected behavior due to truncation or overflow.

## Casting Between Pointers {#skip4}

Pointer casting requires [`unsafe`](https://doc.rust-lang.org/std/keyword.unsafe.html)↗{{hi:unsafe}} blocks and careful consideration of memory management.
...
- Rust encourages the use of [traits][p~traits] like [`From`](https://doc.rust-lang.org/std/convert/trait.From.html)↗{{hi:std::convert::From}}, [`Into`](https://doc.rust-lang.org/std/convert/trait.Into.html)↗{{hi:std::convert::Into}}, [`TryFrom`](https://doc.rust-lang.org/std/convert/trait.TryFrom.html)↗{{hi:std::convert::TryFrom}}, and [`TryInto`](https://doc.rust-lang.org/std/convert/trait.TryInto.html)↗{{hi:std::convert::TryInto}} for conversions. This makes the code more generic and reusable.
