...
The `FromStr` trait is used for [parsing][p~parsing] strings into other types. Many standard types implement [`FromStr`](https://doc.rust-lang.org/std/str/trait.FromStr.html)↗{{hi:FromStr}}.
