...
The example below shows a `&str` of [JSON][p~json] being parsed. The expected value is declared using the [`serde_json::json`][c~serde_json::json~docs]{{hi:serde_json::json}}↗ macro.
