...
```rust,editable
{{#include ../../../crates/cats/caching/tests/lru/lru.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/caching/tests/lru/moka.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/caching/tests/lru/cached.rs:example}}
```
