...
[`tinysearch`][c-tinysearch]⮳{{hi:tinysearch}} is compiled to WebAssembly to run in a browser. It can be used together with static site generators such as `Jekyll`, `Hugo`, [`Zola`][c-zola-website]⮳{{hi:Zola}}, `Cobalt`, or `Pelican`.
