...
[`RabbitMQ`](https://www.rabbitmq.com)↗{{hi:RabbitMQ}} is an example of a popular message broker that implements the Advanced Message Queuing Protocol. It use cases include microservices communication,
