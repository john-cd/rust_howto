...
| [`std::array`][c~std::array~docs]↗{{hi:std::array}} | Utilities for the array primitive type [[T; N]](https://doc.rust-lang.org/std/primitive.array.html)↗. | [[data-structures | Data Structures]], [[vectors | Vectors]], [[slices | Slices]] |
