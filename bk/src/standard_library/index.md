...
| [`std::char`](https://doc.rust-lang.org/std/char/index.html)↗{{hi:std::char}} | Utilities for the [char][primitive~char]↗ primitive type. |  |
...
| [`std::mem`](https://doc.rust-lang.org/std/mem/index.html)↗{{hi:std::mem}} | Basic functions for dealing with memory, such as [`drop`](https://doc.rust-lang.org/std/mem/fn.drop.html)↗{{hi:std::mem::drop}}. | [[memory-management | Memory Management]] |
...
The following covers portions of the Rust Standard Library that are not otherwise covered by another chapter: core types like [`Option`](https://doc.rust-lang.org/std/option/enum.Option.html)↗{{hi:std::option::Option}}, [`Result`](https://doc.rust-lang.org/std/result/enum.Result.html)↗{{hi:std::result::Result}}; smart pointers; and traits for conversions.
