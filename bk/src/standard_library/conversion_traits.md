...
- [`FromStr`](https://doc.rust-lang.org/std/str/trait.FromStr.html)↗{{hi:std::str::FromStr}} provides _string parsing_ with idiomatic error handling, and it's typically implemented for types like [`u32`](https://doc.rust-lang.org/std/primitive.u32.html)↗{{hi:u32}}, `Url`, and enumerations{{hi:enum}}. It powers [`.parse::<T>()`](https://doc.rust-lang.org/std/primitive.str.html#method.parse)↗{{hi:str::parse}}. It can only parse types that do not contain a lifetime parameter.
