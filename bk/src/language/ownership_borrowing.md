...
Such stack-only values, and more precisely all types that implement the [`std::marker::Copy`][c-std::marker::Copy]{{hi:std::marker::Copy}}⮳ trait, use "Copy Semantics" instead:
