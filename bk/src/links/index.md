...
- [Rust Path vs PathBuf - Nick's Blog and Digital Garden](https://nick.groenen.me/notes/rust-path-vs-pathbuf/)
...
- [Tera](https://keats.github.io/tera/docs/#built-in-filters)
...
- [crates.io: Rust Package Registry](https://crates.io/crates/abnf_to_pest/reverse_dependencies)
- [Why is `Sized` trait not allowed in dyn MyTrait? - The Rust Programming Language Forum](https://users.rust-lang.org/t/why-is-sized-trait-not-allowed-in-dyn-mytrait/125323/13)
- [Fast Track to Rust](https://freddiehaddad.github.io/fast-track-to-rust/)
- [regex_automata](https://docs.rs/regex-automata/0.4.9/regex_automata/#should-i-be-using-this-crate)
- [Adding --options to Just recipes](https://marc.cx/article/adding-options-to-just-recipes)
...
- [GitHub - roxygen: Add documentation to function arguments in Rust](https://github.com/geo-ant/roxygen)
...
- [GitHub - rustowl: Visualize Ownership and Lifetimes in Rust](https://github.com/cordx56/rustowl)
