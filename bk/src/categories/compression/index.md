...
General Purpose: flate2 (`zlib`, `gzip`, [`deflate`][c-deflate]⮳{{hi:deflate}}), [`miniz_oxide`][c-miniz_oxide]⮳{{hi:miniz_oxide}} (zlib), `zstd` (Zstandard), `lz4`
Specialized: [`brotli`][c-brotli]⮳{{hi:brotli}} (Brotli), `snap` (Snappy)
Archiving: [`tar`][c-tar]⮳{{hi:tar}}, `zip`
