...
| [Use nalgebra Vectors][ex~mathematics~nalgebra-vectors] | [![nalgebra][c~nalgebra~docs~badge]][c~nalgebra~docs] | [![cat~mathematics][cat~mathematics~badge]][cat~mathematics] |
| [Apply Transformations][ex~mathematics~nalgebra-transformations] | [![nalgebra][c~nalgebra~docs~badge]][c~nalgebra~docs] | [![cat~mathematics][cat~mathematics~badge]][cat~mathematics] |
| [Decompose a Matrix with SVD][ex~mathematics~nalgebra-svd] | [![nalgebra][c~nalgebra~docs~badge]][c~nalgebra~docs] | [![cat~mathematics][cat~mathematics~badge]][cat~mathematics] |
