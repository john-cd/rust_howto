...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/complex_numbers/create_complex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/complex_numbers/add_complex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/complex_numbers/mathematical_functions.rs:example}}
```
