...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/stats/central_tendency.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/stats/central_tendency1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/stats/central_tendency2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/mathematics/tests/stats/standard_deviation.rs:example}}
```
