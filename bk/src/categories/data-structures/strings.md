...
- Use [`std::string::String`][c~std::string::String~docs]↗{{hi:std::string::String}} when you need to modify a string, own string data (e.g., to pass it to another thread or store it in a struct that owns it), or create a new string at runtime.
