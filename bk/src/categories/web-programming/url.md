...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/parse.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/base.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/new.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/origin.rs:example}}
```

[`url::Url::origin`][c-url::Url::origin]{{hi:url::Url::origin}}⮳ produces the same result.

```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/origin1.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/web_programming/tests/url/fragment.rs:example}}
```
