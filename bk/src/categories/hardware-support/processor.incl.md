...
| [SIMD (Single Instruction, Multiple Data) Operations][ex-hardware-support-simd] | {{!crate std::arch}} | [![cat-hardware-support][cat-hardware-support-badge]][cat-hardware-support] |
