...
```rust,editable
{{#include ../../../crates/ex/cats/memory_management/tests/once_cell/once_cell.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/memory_management/tests/once_cell/once_cell2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/memory_management/tests/lazy_static/lazy_static.rs:example}}
```
