...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/duration/profile.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/checked.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/timezone.rs:example}}
```
