...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/current.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/timestamp.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/format.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/date_and_time/tests/chrono/parse_string_into_datetime.rs:example}}
```
