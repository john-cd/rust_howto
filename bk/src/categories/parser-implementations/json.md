...
[`serde_json`][c-serde_json::from_str]⮳{{hi:serde_json}} [`serde_json`][c-serde_json::json]⮳{{hi:serde_json}} [`serde_json`][c-serde_json::to_string]⮳{{hi:serde_json}} [`serde_json`][c-serde_json::Value]⮳{{hi:serde_json}} [`serde_json`][c-serde_json]⮳{{hi:serde_json}}  offers a JSON serialization file format.
