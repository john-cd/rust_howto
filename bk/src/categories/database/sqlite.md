...
```rust,editable
{{#include ../../../crates/ex/cats/database/tests/sqlite/initialization.rs:example}}
```
...
{{#include ../../../crates/ex/cats/database/tests/sqlite/insert_select.rs:example}}
```
...
```rust,editable,noplayground
{{#include ../../../crates/ex/cats/database/tests/sqlite/transactions.rs:example}}
```
