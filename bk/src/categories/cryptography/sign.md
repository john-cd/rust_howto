...
[`ed25519-dalek`][c-ed25519_dalek]⮳{{hi:ed25519-dalek}} contains ed25519 EdDSA key generation, signing, and verification algorithms in pure Rust.
...
[`ecdsa`][c-ecdsa]⮳{{hi:ecdsa}} contains a pure Rust implementation of the Elliptic Curve Digital Signature Algorithm (ECDSA) as specified in FIPS 186-4 (Digital Signature Standard), providing RFC6979 deterministic signatures as well as support for added entropy.
