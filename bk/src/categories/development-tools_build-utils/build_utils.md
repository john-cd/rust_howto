...
```rust,editable
{{#include ../../../crates/cats/development_tools_build_utils/tests/cc_bundled_cpp.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/development_tools_build_utils/tests/cc_defines.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/cats/development_tools_build_utils/tests/cc_defines1.rs:example}}
```
