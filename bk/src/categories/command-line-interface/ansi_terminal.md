...
[`anstyle`][c-anstyle] provides ANSI text styling.
...
[`nu-ansi-term`][c-nu_ansi_term] is a library for ANSI terminal colors and styles (bold, underline)
...
[`ansiterm`][c-ansiterm] is a library for ANSI terminal colors and styles (bold, underline)
...
[`console`][c-console] is a terminal and console abstraction for Rust
...
[`owo-colors`][c-owo_colors] is a zero-allocation terminal colors that will make people go owo
...
[`yansi`][c-yansi] is a simple ANSI terminal color painting library.
