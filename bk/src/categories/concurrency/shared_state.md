...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/global_mut_state.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/shared_state_mutex.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/shared_state_parking_lot.rs:example}}
```

```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/shared_state_parking_lot2.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/shared_state_atomics.rs:example}}
```
...
```rust,editable
{{#include ../../../crates/ex/cats/concurrency/tests/shared_state/shared_state_crossbeam.rs:example}}
```
