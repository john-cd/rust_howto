...
Please also consult the [`TODO.md`][rust-howto~todo~github] file and the [`drafts`][rust-howto~drafts~github] and [`later`](https://github.com/john-cd/rust_howto/tree/main/bk/later)↗ folders.
