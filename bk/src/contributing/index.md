...
Draft chapters are kept in the [`bk/drafts`][rust-howto~drafts~github]↗ and [`bk/later`][rust-howto~bk-later~github]↗ directories.
...
> If you want to ask a question, we assume that you have read the [README][rust-howto~readme~github]↗.
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions Make sure that you have read the [README][rust-howto~readme~github]↗. If you are looking for support, you might want to check [this section][ex~contributing~i-have-a-question]↗.
...
- Make sure that you are using the latest version.
- Read the [README][rust-howto~readme~github]↗ carefully and find out if the functionality is already covered, maybe by an individual configuration.
...
- You may want to **include screenshots and animated GIFs** which help you demonstrate the steps or point out the part which the suggestion is related to. You can use [this tool][licecap~website]↗ to record GIFs on macOS and Windows, and [this tool][silentcast~github]↗ on Linux.
